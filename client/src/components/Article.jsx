...
const Component = styled(Card)`
    margin-bottom: 20px;
    box-shadow: 0 20px 5px 0 rgb(0 0 0 / 16%), 0 2px 10px 0 rgb(0 0 0 / 12%);             
`
            ...
            <Container>
                <Grid container>
                    ...
                    <RightContainer lg={7} md={7} sm={7} xs={12} item>
                        ...
                        <Publisher>
                            read more at &nbsp;
                            <a style={{ textDecoration: 'none', color: '#000'}} href={data.link} target="_blank" rel="noreferrer"><b> {data.publisher} </b></a></Publisher>
                    </RightContainer>
                </Grid>
            </Container>
        </Component>
